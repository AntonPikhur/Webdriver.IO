...
describe('Testing of Telnyx main page using Webdriver.IO', () => {
    ...
    it('13. Should сlick on "International Numbers" button and transfer to correct page', async() => {
    ...
    it('15. Should сlick on "Wireless" button transfer to correct page', async() => {
